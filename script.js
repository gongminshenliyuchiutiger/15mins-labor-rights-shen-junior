const modulesData = [
    // 個體勞動 (Individual Labor) - 15 Modules
    {
        id: 1, type: 'individual', icon: 'fa-store', title: '我幫爸媽顧店算勞工嗎？', subtitle: '「勞工」的定義',
        prep: '準備幾張不同職業的情境圖卡。',
    ...
    {
        id: 2, type: 'individual', icon: 'fa-child-reaching', title: '我幾歲才能開始打工？', subtitle: '童工與年齡限制',
        prep: '法定代理人同意書範本。',
        goal: '認識法定工作年齡與童工保護條款。',
        steps: [
            { time: '3m', icon: 'fa-shoe-prints', type: '情境引入', content: '國八的阿志想買球鞋，看到飲料店徵人，他可以去應徵嗎？', q: '國八大約14歲，老闆可以直接僱用他嗎？', a: '不行。未滿15歲原則上不能合法工作（除非特例如童星且有主管機關許可）。' },
    ...
    },
    {
        ...
        summary: '求職前多查、面試時帶人、七不三要記心頭。'
    },
    {
        id: 4, type: 'individual', icon: 'fa-id-card', title: '我的第一份工作契約', subtitle: '勞動契約基礎知識',
    ...
    {
        id: 6, type: 'individual', icon: 'fa-shield-heart', title: '職場安全「三要」與職災', subtitle: '職場防護與補償',
        prep: '現場危險圖、三要防禦卡。',
    ...
    {
        id: 7, type: 'individual', icon: 'fa-sack-dollar', title: '試用期沒薪水對嗎？', subtitle: '基本工資保障',
        prep: '當年度最新工資數值投影。',
    ...
    {
        id: 8, type: 'individual', icon: 'fa-hourglass-half', title: '工作幾小時要休息？', subtitle: '工時與休息間隔',
        prep: '排班表範本。',
    ...
    {
        id: 9, type: 'individual', icon: 'fa-calendar-check', title: '一週到底休幾天？', subtitle: '一例一休規則',
        prep: '一週日曆卡。',
    ...
    {
        id: 10, type: 'individual', icon: 'fa-suitcase-rolling', title: '我的特休在哪裡？', subtitle: '特別休假權益',
        prep: '特休天數對照表。',
        goal: '學會計算特休天數，掌握排定權。',
        steps: [
    ...
    {
        id: 11, type: 'individual', icon: 'fa-file-invoice-dollar', title: '打工族也有特休嗎？', subtitle: '部分工時勞工權益',
        prep: '兼職薪資計算題。',
    ...
    {
        id: 12, type: 'individual', icon: 'fa-clock', title: '加班費怎麼算才不虧？', subtitle: '工時與加班規範',
        prep: '投影計算機介面。',
    ...
    {
        id: 13, type: 'individual', icon: 'fa-venus-mars', title: '職場也要男女平等', subtitle: '性別平等與防護',
        prep: '性平法重點圖卡。',
    ...
    {
        id: 14, type: 'individual', icon: 'fa-user-secret', title: '老闆能看我的 LINE 嗎？', subtitle: '職場隱私與通訊',
        prep: '隱私侵權案例摘要。',
    ...
    {
        id: 15, type: 'individual', icon: 'fa-gavel', title: '遇到慣老闆找誰助？', subtitle: '權利救濟管道',
        prep: '1955 專線圖案。',
    ...
    // 集體勞動 (Collective Labor) - 13 Modules
    {
        id: 16, type: 'collective', icon: 'fa-users', title: '為什麼單打獨鬥沒用？', subtitle: '勞資權力不對等',
        prep: '一張椅子與十張椅子的對比感。',
        goal: '認同集體發聲的必要。',
        steps: [
    ...
    {
        id: 17, type: 'collective', icon: 'fa-shield-heart', title: '組隊打怪不犯法！', subtitle: '憲法結社權',
        prep: '憲法第 14 條條文。',
        goal: '確認組工會權力受憲法保障。',
        steps: [
    ...
    {
        id: 18, type: 'collective', icon: 'fa-handshake', title: '工會都在做什麼？', subtitle: '多元服務角色',
        prep: '各式工會活動照片。',
        goal: '破除對工會的刻板印象。',
        steps: [
    ...
    {
        id: 19, type: 'collective', icon: 'fa-tower-broadcast', title: '力量不夠？打電話找隊友', subtitle: '跨公司工會資源',
        prep: '工會 Logo。',
        goal: '知道可加入外部工會獲援。',
        steps: [
    ...
    {
        id: 20, type: 'collective', icon: 'fa-chart-pie', title: '公司賺錢怎麼分？', subtitle: '集體協約威力',
        prep: '圓餅圖圖標（年終、特別假）。',
        goal: '理解團體協約優於勞基法。',
        steps: [
    ...
    {
        id: 21, type: 'collective', icon: 'fa-comments', title: '坐下來好好談：勞資會議', subtitle: '法定協商平台',
        prep: '會議示意圖。',
        goal: '認識勞資會議的制度。',
        steps: [
    ...
    {
        id: 22, type: 'collective', icon: 'fa-scale-balanced', title: '什麼事都可以罷工嗎？', subtitle: '罷工的界線與限制',
    ...
    {
        id: 23, type: 'collective', icon: 'fa-bullhorn', title: '權利與代價：看見罷工', subtitle: '抗爭實例反思',
        prep: '罷工片段。',
        goal: '透過案例反思。',
        steps: [
    ...
    {
        id: 24, type: 'collective', icon: 'fa-eye-slash', title: '別讓標籤抹黑罷工', subtitle: '標籤辨識媒體識讀',
        prep: '負面留言。',
        goal: '媒體識讀。',
        steps: [
    ...
    {
        id: 25, type: 'collective', icon: 'fa-list-check', title: '罷工不是想罷就罷的', subtitle: '嚴格法定程序',
        prep: '五關流程卡。',
        goal: '掌握法律尊重與限制。',
        steps: [
    ...
    {
        id: 26, type: 'collective', icon: 'fa-gavel', title: '公務員能罷工嗎？', subtitle: '罷工權界限與權衡',
        prep: '分類牌。',
        goal: '掌握職業限制。',
        steps: [
    ...
    {
        id: 27, type: 'collective', icon: 'fa-users-viewfinder', title: '集體權益大會師', subtitle: '課程總複習與總結',
        prep: '總結回顧表。',
        goal: '鞏固集體勞動權益核心概念。',
        steps: [
    ...
    {
        id: 28, type: 'collective', icon: 'fa-graduation-cap', title: '我是有勞動素養的公民', subtitle: '勞動公民素養總整理',
        prep: '學習護照或自我承諾卡。',
